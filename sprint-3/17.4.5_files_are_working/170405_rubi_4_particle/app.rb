...
get '/incoming_sms' do
  ...
  if body.include? "off" or body.include? "quiet"
    ...
    message = "Whoaaaa, #{ body } days?! Lets stay under a month. Enter a number 1-30."
  elsif not defined? session["last_context"] or get_context == nil
      session["last_context"] = "first_error"
    ...
    message = "Hmmm, je ne comprende pas. Please enter a value 1-30 or place me in the fridge."
  end

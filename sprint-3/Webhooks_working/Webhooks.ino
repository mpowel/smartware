...
void hook1Ask(){   // Triggers particle console webhook
  if( state == 6 ){
...
//=============================================================================
//   Playing with str extract >> int extract in case user types "1 days". How do I strip "days"? Might be easiest in app.rb
//=============================================================================
...
String tryExtractInt(String str, const char* start, const char* end)
{
    ...
    /*int endsIdx = str.indexOf(days);
    if (endsIdx < 0) {
        return NULL;
    }

    int endIdx = str.indexOf(day);
    if (endIdx < 0) {
        return NULL;
    }
